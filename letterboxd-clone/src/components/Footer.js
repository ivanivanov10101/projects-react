const Footer = () => {
  return (
    <footer id="page-footer" className="page-footer js-page-footer js-hide-in-app">
      <div className="content-wrap">
        ...
        <div className="socials">
          <nav className="social-service-list -inline">
            <div className="listitem -icononly">
              <a className="trigger tooltip" href="https://twitter.com/letterboxd" target="_blank"
                 rel="noopener noreferrer" data-original-title="Letterboxd on X">
                <svg className="glyph" aria-hidden="true" role="presentation" xmlns="http://www.w3.org/2000/svg"
                     width="17" height="17">
            ...
            <div className="listitem -icononly">
              <a className="trigger tooltip" href="https://www.threads.net/@letterboxd" target="_blank"
            ...
            <div className="listitem -icononly">
              <a className="trigger tooltip" href="https://www.facebook.com/letterboxd" target="_blank"
                 rel="noopener noreferrer" data-original-title="Letterboxd on Facebook">
                <svg className="glyph" aria-hidden="true" role="presentation" width="19" height="19"
            ...
            <div className="listitem -icononly">
              <a className="trigger tooltip" href="https://www.instagram.com/letterboxd" target="_blank"
                 rel="noopener noreferrer" data-original-title="Letterboxd on Instagram">
                <svg className="glyph" aria-hidden="true" role="presentation" width="20" height="20"
                     xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div className="listitem -icononly">
              <a className="trigger tooltip" href="https://www.tiktok.com/@letterboxd" target="_blank"
                 rel="noopener noreferrer" data-original-title="Letterboxd on TikTok">
                <svg className="glyph" aria-hidden="true" role="presentation" width="17" height="18"
                     xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div className="listitem -icononly">
              <a className="trigger tooltip" href="https://www.youtube.com/letterboxdhq" target="_blank"
                 rel="noopener noreferrer" data-original-title="Letterboxd on YouTube">
                <svg className="glyph" aria-hidden="true" role="presentation" width="23" height="16"
                     xmlns="http://www.w3.org/2000/svg">
                  <path
        ...
        <p className="copyright">
          ...
          <span className="nobr">
            <a href="https://letterboxd.com/about/film-data/" className="mute">
              Film data
            </a>
            from
            <a href="https://www.themoviedb.org" className="mute">
              TMDb
						...
						<a href="#" className="mute mobile-site-switch" data-use-mobile-site="yes">
              Mobile&nbsp;site
            </a>.
          </span>
          <span className="recap" >
            This site is protected by reCAPTCHA and the Google
              <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="mute">
                privacy policy
              </a>
              and
              <a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer" className="mute">
                terms of service
              </a>
            </span>
        </p>
