...
const reviews = [
	...
	},
	{
		id: 3,
		name: 'Colin the dude',
		comment: 'The exorcism subgenre doesn\'t need just a makeover, but reconstructive surgery. I feel like the same demon keeps possessing every one of these movies and therefore they all have the same personality. A copy of a copy of a copy of a copy. The SAG strike needs to carve out some space for a wider pool of demon representation. I want to meet a demon who doesn\'t growl for two hours and speaks with the intellect of a Hannibal Lector or something. Give me something new.',
		stars: 3,
		movie: movies[3].name,
